  ...
  return (
    <div className="max-w-md mx-auto bg-white border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-700">
      <div className="bg-slate-900 text-white p-8 text-center relative">
        ...
        <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-xl mx-auto mb-4 border-2 border-slate-800">
          D
        </div>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-4 bg-slate-50 rounded-[2rem] border border-slate-100 relative group overflow-hidden">
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 group-hover:scale-105 transition-transform duration-500">
            <img src={qrUrl} alt="Verification QR" className="w-32 h-32" />
          </div>
      ...
      <div className="p-4 text-center">
        <p className="text-[8px] font-black text-slate-300 uppercase tracking-[0.4em]">
          DataBook Secure Transaction v4.2
        </p>
      </div>
    </div>
  );
...
const BookingWizard: React.FC<BookingWizardProps> = ({
  ...
  const [selectedPaymentMethod, setSelectedPaymentMethod] =
    useState<PaymentMethod>(PaymentMethod.ABA_PAY);
  ...
  const handleBookingComplete = () => {
    ...
    const newBooking: Booking = {
      ...
      paymentStatus:
        selectedPaymentMethod === PaymentMethod.PAY_LATER
        ...
        <div className="flex items-center justify-between max-w-2xl mx-auto">
          {[0, 1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="flex items-center">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-[10px] transition-all duration-500 ${
                  step >= i
              ...
              {i < 6 && (
                <div
                  className={`w-8 md:w-12 h-0.5 mx-1 md:mx-2 transition-all duration-500 ${
        ...
        {step === 1 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-black text-slate-900 tracking-tight">
                  Services at {selectedLocation?.name}
                </h3>
                <p className="text-sm text-slate-500">
                  Precision protocols authorized for this branch.
                </p>
              </div>
            </div>
        ...
        {step === 5 && (
          <div className="space-y-10 animate-in fade-in slide-in-from-right-4 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  id: PaymentMethod.ABA_PAY,
                  label: "ABA PAYWAY",
                  icon: Wallet,
                  desc: "Instant local bank settlement",
                },
                {
                ...
                },
                {
                  ...
                  label: "CREDIT CARD",
                  icon: CreditCard,
                  desc: "Direct processing gateway",
                },
                {
                  id: PaymentMethod.PAY_LATER,
                  label: "PAY AT COUNTER",
                  icon: Store,
                  desc: "Settlement upon arrival",
                },
              ].map((method) => (
                <button
                  key={method.id}
                ...
                >
                  ...
                  <p className="font-black text-[10px] uppercase tracking-widest text-slate-400 mb-1">
                    {method.label}
                  </p>
        ...
        {step === 6 && (
          <div className="space-y-8 text-center py-20 animate-in zoom-in duration-700">
            ...
            <p className="text-slate-400 font-bold">
              Processing {selectedPaymentMethod} for {selectedLocation?.name}...
            </p>
            <button
            ...
            <div className="py-10 animate-in zoom-in duration-500 space-y-12">
              <div className="text-center">
                ...
                <p className="text-slate-500 font-medium">
                  Session verified and synced with {selectedLocation.name}.
                </p>
              </div>
