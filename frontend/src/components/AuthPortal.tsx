    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="flex items-center gap-3 mb-10 justify-center">
          <div className="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-2xl shadow-indigo-500/40">
            D
          </div>
        ...
        <div className="bg-slate-900/40 backdrop-blur-3xl border border-slate-800 rounded-[3rem] p-10 shadow-2xl">
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm">
              {mode === "LOGIN"
                ? "Access your elite management suite."
                : "Join the precision scheduling network."}
            </p>
          </div>
        ...
        <div className="mt-10 flex items-center justify-center gap-6 text-slate-600">
          ...
          <button className="text-[10px] font-black uppercase tracking-widest hover:text-slate-400">
            Terms
          </button>
          <div className="w-1 h-1 bg-slate-800 rounded-full"></div>
          <button className="text-[10px] font-black uppercase tracking-widest hover:text-slate-400">
